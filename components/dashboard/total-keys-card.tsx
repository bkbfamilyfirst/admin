  ...
  return (
    <Card className="relative overflow-hidden border-0 bg-gradient-to-br from-electric-purple/10 to-electric-blue/10 hover:shadow-xl transition-all duration-300 hover:scale-105">
      ...
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        <CardTitle className="text-sm font-medium text-gray-700 dark:text-gray-300">Total Keys</CardTitle>
      ...
      <CardContent>
        ...
        <div className="flex items-center gap-1 mt-2">
          ...
          <p className="text-sm text-electric-green font-medium">+15.3% from last month</p>
        </div>
        <div className="mt-3 flex justify-between text-xs text-muted-foreground">
          <span>Active: 11,234</span>
          <span>Inactive: 1,613</span>
        </div>
      </CardContent>
    </Card>
  )
